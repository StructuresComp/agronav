...
parser.add_argument('--model', default="./checkpoint/model_best.pth", help='path to the pretrained model')
parser.add_argument('--align', default=False, action='store_true')
parser.add_argument('--tmp', default="./data/inference/output/", help='tmp')
